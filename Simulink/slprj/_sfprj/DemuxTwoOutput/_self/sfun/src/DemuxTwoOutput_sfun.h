#ifndef __DemuxTwoOutput_sfun_h__
#define __DemuxTwoOutput_sfun_h__
...
extern mxArray* load_DemuxTwoOutput_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_DemuxTwoOutput_optimization_info(void);
