...
MODEL     = DemuxTwoOutput
TARGET      = sfun
MODULE_SRCS   = c2_DemuxTwoOutput.c half_type.c
MODEL_SRC  = DemuxTwoOutput_sfun.c
MODEL_REG = DemuxTwoOutput_sfun_registry.c
MAKEFILE    = DemuxTwoOutput_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\ferbe\Desktop\Stevens\SSW-345\Simulink"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\ferbe\Desktop\Stevens\SSW-345\Simulink\slprj\_sfprj\DemuxTwoOutput\_self\sfun\src" 
...
OBJLIST_FILE = DemuxTwoOutput_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
